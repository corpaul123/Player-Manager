...
public class Main{
  ...
  public static void EnterEnemy(int enemyInit, int enemyCount, HashMap<String, Integer> initiative){
  ...
  public static void main(String[] args) {
    ...
    if(enem == true){
      ...
      scanner.nextLine();
      int enemyInit = scanner.nextInt();
      scanner.nextLine();

      EnterEnemy(enemyInit,enemyCount, initiative);
